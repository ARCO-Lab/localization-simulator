...
def parseArgs():
     ...
     parser.add_argument("--h", "-headless", default = False, required = False, action="store_true", help="Flag to run simulations in headless mode.")
     parser.add_argument("--s", "-save", default = False, required = False, action="store_true", help="Flag to save simulation results.")
